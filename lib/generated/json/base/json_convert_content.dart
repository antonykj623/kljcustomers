...
class JsonConvert {
  ...
  static M? _getListChildType<M>(List<Map<String, dynamic>> data) {
    if (<CafeMenuEntity>[] is M) {
      return data.map<CafeMenuEntity>((Map<String, dynamic> e) =>
          CafeMenuEntity.fromJson(e)).toList() as M;
    }
    if (<CafeMenuData>[] is M) {
      return data.map<CafeMenuData>((Map<String, dynamic> e) =>
          CafeMenuData.fromJson(e)).toList() as M;
    }
    if (<NotificationEntity>[] is M) {
      return data.map<NotificationEntity>((Map<String, dynamic> e) =>
          NotificationEntity.fromJson(e)).toList() as M;
    }
    if (<NotificationData>[] is M) {
      return data.map<NotificationData>((Map<String, dynamic> e) =>
          NotificationData.fromJson(e)).toList() as M;
    }
    if (<QrEntity>[] is M) {
    ...
    if (<UserProfileData>[] is M) {
      return data.map<UserProfileData>((Map<String, dynamic> e) =>
          UserProfileData.fromJson(e)).toList() as M;
    }
    if (<UserTokenEntity>[] is M) {
      return data.map<UserTokenEntity>((Map<String, dynamic> e) =>
          UserTokenEntity.fromJson(e)).toList() as M;
    }
    if (<UserTokenData>[] is M) {
